...
var async, commentTransform, compilerAliases, concatAll, createIterator, emptyConfig, fragmenter, fs, parseConfig, resolveCompilerAlias;
fs = require('fs');
...
fragmenter = function (mcOptions, options) {
  var anyFragExpr, config, createFragment, defaultFragments, defaultModelFragments, fragments, fragmentStack, srcPath, topFragment, topFragments;
